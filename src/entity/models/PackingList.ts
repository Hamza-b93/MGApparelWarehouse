...
export class PackingList {
  ...
  @Column("varchar", { name: "Customer", nullable: true, length: 64 })
  customer: string | null;

  @Column("varchar", { name: "Supplier", nullable: true, length: 64 })
  supplier: string | null;

  @Column("varchar", { name: "SupplierLot", nullable: true, length: 64 })
  supplierLot: string | null;

  @Column("int", { name: "SupplierRollID", nullable: true })
  supplierRollId: number | null;

  @Column("varchar", { name: "FabricType", nullable: true, length: 64 })
  fabricType: string | null;

  @Column("varchar", { name: "FabricWidth", nullable: true, length: 64 })
